...
#define ATTRIB_A		0x23c0
#define ATTRIB_B		0x27c0
...
//sprite attributes
#define ATSPR(x,y,z) ((x<<7)|(y<<6)|(z<<0))

#define ATADR_A(x,y) 	(ATTRIB_A|(((y)<<5)|(x))) 
#define ATADR_B(x,y) 	(ATTRIB_B|(((y)<<5)|(x))) 
#define ATSQ(a,b,c,d)	((a)|(b<<2)|(c<<4)|(d<<6))
#define ATSQ_L(a,c)	((a)|(c<<4))
#define ATSQ_R(b,d)	((b<<2)|(d<<6))
#define ATSQ_H(a,b)	((a)|(b<<2))
